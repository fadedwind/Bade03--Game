...
while meta_run:
    ...
    while run:
        ...
        write_text(screen, width//2, height//8 , 'Rhythm!', big_text, background_color[0], highlight_text_color)
        ...
        write_text(screen, width // 2, height-small_text*4, 'Rules of the Game: ', small_text, background_color[0],
                   highlight_text_color)
        write_text(screen, width // 2, height-small_text*2, 'press %s,%s,%s,%s in precise time!'%(guide_keys[0],guide_keys[1],guide_keys[2],guide_keys[3]), small_text, background_color[0],
                   highlight_text_color)

        if mouse_particle_list:  
