...
height = line_length + info_length 
...
hold_color = [(190,190,190),(70,70,60)] 
...
score_colors = {'Pure Perfect!!! (PP)':(255,215,0),'Perfect (P)':(200,230,255),'AA':(255,223,79),'A':(230,200,50),'B':(169,194,169),'C':(200,200,240),'D':(240, 180, 180),'E':(210, 160, 160),'Failed':(160,160,160)}
