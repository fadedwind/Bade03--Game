...
class Verifier():
    def __init__(self,screen, score,speed,judgement_shown,bpm,high_quality_verifying_graphics, given_fps):
        ...
        self.judgement_frames = given_fps//2 
        ...
        self.verification_show_time = 100 
        ...
        self.pure_perfect_tolerance =self.appropriate_bit_pixel_size * 0.2  
        self.perfect_tolerance = self.appropriate_bit_pixel_size* 0.4  
        self.hit_tolerance = self.appropriate_bit_pixel_size * 0.8  
        self.judgement_tolerance = self.appropriate_bit_pixel_size  
